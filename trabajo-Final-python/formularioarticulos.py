...
class FormularioArticulos:
    def __init__(self):
        ...
        self.ventana1=tk.Tk()
        self.ventana1.title("Inventario Equipos Informaticos")
        self.ventana1.configure(bg="#90C67C")
    ...
    def carga_articulos(self):
        ...
        self.label2=ttk.Label(self.labelframe1, text="Precios:")        
    ...
    def agregar(self):
        ...
        mb.showinfo("Información", "Los Datos fueron Agregados")
    ...
    def consultar(self):
        ...
        if len(respuesta)>0:
            ...
            self.precio.set('')
            mb.showinfo("¡ALERTA!", "No existe un artículo con este Codigo")
